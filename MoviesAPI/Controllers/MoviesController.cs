...
namespace MoviesAPI.Controllers
{
    ...
    public class MoviesController:ControllerBase
    {
        ...
        public MoviesController(ApplicationDbContext context,IMapper mapper,
            IFileStorageService fileStorageService,ILogger logger)
        {
        ...
        public async Task<ActionResult<List<MovieDTO>>> Filter([FromQuery] FilterMoviesDTO filterMoviesDTO)
        {
            ...
            {
                moviesQueryable = moviesQueryable.Where(x => x.Tittle.Contains(filterMoviesDTO.Title));
            }
        ...
        public async Task<ActionResult> Post([FromForm] MovieCreationDTO movieCreationDTO)
        {
            ...
            if(movieCreationDTO.Poster != null)
            {
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    var extention = Path.GetExtension(movieCreationDTO.Poster.FileName);
                    movie.Poster = await fileStorageService.SaveFile(content, extention, 
